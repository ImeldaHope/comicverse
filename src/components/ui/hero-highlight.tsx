...
export const HeroHighlight = ({
  ...
  const dotPatterns = {
    light: {
      default: `url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16' fill='none'%3E%3Ccircle fill='%23facc15' id='pattern-circle' cx='10' cy='10' r='2.5'%3E%3C/circle%3E%3C/svg%3E")`,
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-red-500 to-yellow-400 px-1 pb-1 dark:from-red-700 dark:to-yellow-600 `,
        className
      )}
    >
      {children}
