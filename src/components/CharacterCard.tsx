...
export function CharacterCard({ character }: { character: Character }) {
  ...
  return (
    <CometCard>
      <button
        type="button"
        className="my-10 flex w-80 cursor-pointer flex-col items-stretch rounded-[16px] border-0 bg-[#1F2121] p-2 saturate-0 hover:saturate-100 md:my-20 md:p-4 overflow-hidden"
